;jQuery( function() {
    ...
    $("#logout").click(function(){
           ...
           // console.log("项目名",getRootPath_webStr);
           top.sessionStorage.clear();

           JsSetCookie('tokenMyb',"");

           // window.top.location.href=".."+getRootPath_webStr+"/login.html";

            window.top.location.href="../ginv2/login.html";

    })


    $("#checkoutOldVerSpan").click(function(){
        // console.log("进来")
        window.top.location.href="../../dyadminold/index.html";
